...
--
-- Host: localhost
-- Generation Time: Apr 08, 2017 at 12:46 
...
--
-- Table structure for table `blogBillet`
--

CREATE TABLE `blogBillet` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `blogBillet`
--

INSERT INTO `blogBillet` (`id`, `user`, `contenu`, `dateDeCreation`) VALUES
(1, 'Billy', 'Je suis sur un super blog réalisé en PHP et MySql. Regardez et commentez.', '2017-04-07 15:22:42'),
(2, 'Zaza', 'Petite vacances au ski!', '2017-04-07 07:03:48');

-- --------------------------------------------------------

--
-- Table structure for table `blogCommentaire`
--

CREATE TABLE `blogCommentaire` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `blogCommentaire`
--

INSERT INTO `blogCommentaire` (`id`, `idBillet`, `user`, `contenu`, `dateDeCreation`) VALUES
(1, 1, 'Tony', 'Super ton blog!', '2017-04-07 16:23:43'),
(2, 2, 'Laura', 'Trop cool ces vacances', '2017-04-07 06:30:42'),
(3, 1, 'Elliot', 'Blog pas mal j\'aimle bien les couleurs', '2017-04-07 18:48:52'),
(4, 2, 'Billy', 'J\'adore le ski', '2017-04-07 07:42:22'),
(5, 1, 'Toto', 'Il faut que tu me fasse le même blog', '2017-04-07 17:07:51'),
(6, 1, 'Edi', 'J\'aime ce blog', '2017-04-07 07:39:22');
...
--
-- Indexes for table `blogBillet`
--
ALTER TABLE `blogBillet`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `blogCommentaire`
--
ALTER TABLE `blogCommentaire`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `blogBillet`
--
ALTER TABLE `blogBillet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `blogCommentaire`
--
ALTER TABLE `blogCommentaire`
